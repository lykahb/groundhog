...
bigdata :: DbType
bigdata = dbType (((((s, s), (s, s)), ((s, s), (s, s))), (((s, s), (s, s)), ((s, s), (s, s)))), ((((s, s), (s, s)), ((s, s), (s, s))), (((s, s), (s, s)), ((s, s), (s, s)))))
  where
    s = "" :: String
...
main =
  defaultMain
    [ bgroup
        "renderChain1"
        [ bench "chain1simple" $ nf (map fromStringS' . ($ []) . renderField1 id) chain1simple,
      ...
      bgroup
        "renderChain2"
        [ bench "chain2simple" $ nf (map fromStringS' . ($ []) . renderField2 id) chain2simple,
